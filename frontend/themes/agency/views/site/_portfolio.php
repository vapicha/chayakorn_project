        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">กิจกรรมต่างๆที่ทางศูนย์อบรมจัดขึ้น</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?=$directoryAsset?>/img/portfolio/meditation.jpg" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>จัดปฏิบัติธรรม</h4>
                        <p class="text-muted">จัดปฏิบัติธรรมทุกวันเสาร์ตลอดทั้งเดือน</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="<?=$directoryAsset?>/img/portfolio/student.jpg" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>จัดสอนธรรมะเยาวชน</h4>
                        <p class="text-muted">นิมนต์พระอาจารย์ลงเทศน์ให้กับเยาวชน</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <h2>จัดปฏิบัติธรรม</h2>
                            <p class="item-intro text-muted">กิจกรรมปฏิบัติธรรมร่วมกันทุกสัปดาห์เพื่อทำใจให้ผ่องใส ที่ศูนย์อบรมเยาวชนลาดหลุมแก้ว</p>
                            <div class = "col-sm-6">
                                <?=Html::a(Html::img($directoryAsset."/img/portfolio/add-person.png", ['class'=>'img-responsive img-centered', 'title' => 'เพิ่มรายชื่อบุคคลใหม่']), ['person/index']);?>
                            </div>
                            <div class = "col-sm-6">
                                <?=Html::a(Html::img($directoryAsset."/img/portfolio/add-member.png", ['class'=>'img-responsive img-centered', 'title' => 'สมัครเข้าร่วมกิจกรรม']), ['activity/index']);?>
                            </div>
